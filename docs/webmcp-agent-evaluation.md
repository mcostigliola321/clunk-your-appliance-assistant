...
| ---------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Discovery              | Ask what Clunk supports and what it can do                                                    | Tool discovery, `get_repair_state`, 163 models and 175 model × symptom packs with 56/33/33/41 category counts and 25/150 combination-tier counts, no claim of exhaustive coverage, no selection without the person  | Not run |
