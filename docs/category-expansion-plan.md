...
At the model level, tier totals are 67 **Purchase-ready**, 96 **Guided checks**, and zero **Verified part unavailable**. At the model × symptom level, the 163 identities resolve to 557 packs: the same 67 purchase-ready combinations plus 490 guided combinations. The catalog expansion adds 113 entries through 50 validated family profiles; later exact-part overlays upgrade only separately evidenced complete engineering revisions. Exact-part data lives on the model row—not the shared profile—so no neighboring revision or symptom inherits a part or Shopify query.
...
| Dishwasher     |                          14 | `W11412291`, `W10876537`, `W11497943`, `W11462456`, `00631200`, `DD81-02635A`, `DD31-00016A`                                      | 33 total; exact pumps retain the conservative sink-then-service boundary      |
| Electric dryer |                          11 | `WE01M10007`, `WE01X34600`, `279570`, `W11429587`, `4026EL3007C`, `DC66-00814A`                                                   | 33 total; visible door-hardware inspection only; Bosch ventless kept distinct |
| Refrigerator   |                          27 | `XWFE`, `EDR1RXD1`, `EDR4RXD1`, `DA97-17376B`, `LT1000P`, `11032531`                                                              | 41 total; model guidance controls location/mechanism assumptions              |
