...
Clunk now ships a reusable multi-appliance foundation: 163 source-backed U.S. model families across washers, dishwashers, electric dryers, and refrigerators; 11 brands; explicit capability tiers; result-derived state IDs; per-pack component hotspots, result effects, ranking rules, safety boundaries, sources, and optional static/live commerce handoffs. The eight public WebMCP tools did not change as categories, model discovery, evidence filters, and Shopify UCP offer discovery expanded. This is useful breadth, not exhaustive or universal compatibility.

Eighty-four model identities now have at least one **Purchase-ready** route: 15 washers, 23 dishwashers, 18 electric dryers, and 28 refrigerators. At the model × symptom level, all 782 possible pairs are classified: 84 purchase-ready, 682 guided, and 16 explicitly unsupported. The catalog expansion adds 113 entries through 50 validated family profiles; later exact-part overlays upgrade only separately evidenced complete engineering revisions. Exact-part data lives on the model row—not the shared profile—so no neighboring revision or symptom inherits a part or Shopify query.
...
| -------------- | --------------------------: | --------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Washer         |                          15 | `WH11X39237`, `WH23X28418`, `W11399437`, `DC97-20621A`, `DC97-19289F`, `DC97-20621C`, `DC97-22840A`, `AHA75673404`, `AHA75853813` | 56 total; nine brands; front- and top-load external paths                     |
| Dishwasher     |                          23 | `W11412291`, `W10876537`, `W11497943`, `W11462456`, `00631200`, `DD81-02635A`, `DD31-00016A`                                      | 33 total; exact pumps retain the conservative sink-then-service boundary      |
| Electric dryer |                          18 | `WE01M10007`, `WE01X34600`, `279570`, `W11429587`, `4026EL3007C`, `DC66-00814A`                                                   | 33 total; visible door-hardware inspection only; Bosch ventless kept distinct |
| Refrigerator   |                          28 | `XWFE`, `EDR1RXD1`, `EDR4RXD1`, `EDR2RXD1`, `DA97-17376B`, `LT1000P`, `11032531`                                                  | 41 total; model guidance controls location/mechanism assumptions              |

“Purchase-ready” means that a complete product code maps to a manufacturer or authorized-parts source and a dated seller or Shopify UCP handoff. It does not mean Clunk confirms the diagnosis, guarantees stock, certifies a merchant claim, or completes payment. The homeowner UI says **Exact part available** or **Safe checks available** and never silently borrows another model's part.
...
- Forty-two later exact revisions became purchase-ready only after a complete-code-to-SKU mapping was found on a manufacturer or authorized-parts chain: 21 refrigerator filters, ten dishwasher drain pumps, seven washer drain pumps, and four dryer door-side hooks/levers. Ambiguous LG washer pump lists, dryer pages proving only the cabinet catch or complete door assembly, and refrigerator filter pages with multiple candidates were not promoted.
