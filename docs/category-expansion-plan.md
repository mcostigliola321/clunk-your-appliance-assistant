...
At the model level, tier totals are 58 **Purchase-ready**, 105 **Guided checks**, and zero **Verified part unavailable**. At the model × symptom level, the 163 identities resolve to 557 packs: the same 58 purchase-ready combinations plus 499 guided combinations. The catalog expansion adds 113 entries through 50 validated family profiles; later exact-part overlays upgrade only separately evidenced complete engineering revisions. Exact-part data lives on the model row—not the shared profile—so no neighboring revision or symptom inherits a part or Shopify query.
...
| -------------- | --------------------------: | -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| Washer         |                           9 | `WH11X39237`, `WH23X28418`, `W11399437`, `DC97-20621A`, `AHA75673404`                        | 56 total; nine brands; front- and top-load external paths                     |
| Dishwasher     |                          13 | `W11412291`, `W10876537`, `W11497943`, `W11462456`, `00631200`, `DD81-02635A`, `DD31-00016A` | 33 total; exact pumps retain the conservative sink-then-service boundary      |
| Electric dryer |                           9 | `WE01M10007`, `WE01X34600`, `279570`, `W11429587`, `4026EL3007C`                             | 33 total; visible door-hardware inspection only; Bosch ventless kept distinct |
...
- Thirty-three later exact revisions became purchase-ready only after a complete-code-to-SKU mapping was found on a manufacturer or authorized-parts chain: 21 refrigerator filters, nine dishwasher drain pumps, one LG washer drain pump, and two LG dryer door hooks. Ambiguous LG washer pump lists, dryer pages proving only the cabinet catch, and refrigerator filter pages with multiple candidates were not promoted.
