...
- [ ] **4. Build the clean application shell and interactive exploded appliance**
...
- [ ] **5. Build the diagnostic, causes, parts, and repair-context experience**
...
- [ ] **6. Add agent activity, tool inspector, and manual judge mode**
...
- [ ] **7. Harden safety, accessibility, responsiveness, and reduced motion**
